...
One tap. One perfect instant. Build huge combos, master daily challenges, and unlock a neon style that is entirely yours.
...
**Eight timing challenges**
Master moving bars, vertical drops, rotating needles, expanding and contracting rings, bouncing markers, dual markers, and pulse timing.

**Modes for every mood**
- Classic: an endless test where one major miss can end the run
- Rush: score as much as possible in 60 seconds
- Precision: tiny targets, three lives, and high rewards
- Chaos: changing directions, fake targets, and unpredictable patterns
- Daily Challenge: the same deterministic challenge for everyone each day
- Practice: train freely without spending currency or affecting competitive stats
...
timing,reflex,one tap,arcade,casual,reaction,precision,neon,combo,daily challenge
...
- **Large Coin Pack:** 8,000 Timing Coins for cosmetic items.

## Screenshot captions

1. Tap at the perfect moment
2. Master eight timing challenges
3. Build combos and chase your best
4. Six modes, from Classic to Chaos
5. A new shared challenge every day
6. Unlock your neon style
7. Track missions and achievements
8. Play anywhere, even offline
